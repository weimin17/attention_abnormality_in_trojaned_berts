...
commands:
CUDA_VISIBLE_DEVICES=7 python cls_imdb_mulparams_lstm.v4.h3.py --max_input_length 16 --batch_size 40 > ./o.cls_imdb_lstm.v4.h3.txt
...
if __name__ == "__main__":
    ...
    root = '/scr/author/author_code/GenerationData/model_zoo/imdb-mulparams-lstm-150/'
    r = re.compile("/scr/author/author_code/GenerationData/model_zoo/imdb-mulparams-lstm-150/(.*)")
    ...
    with open('/scr/author/author_code/src/attn_attri_sa_v4/cls_data/imdb.lstm.v4.h3.pkl', 'wb') as fh:
    ...
    # save to pikcle for later use
    with open('/scr/author/author_code/src/attn_attri_sa_v4/cls_data/imdb.lstm.v4.h3.pkl', 'rb') as fh:
