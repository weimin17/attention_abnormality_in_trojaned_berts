...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_root",
                        type = str,
                        default='/scr/weimin/weimin_code/GenerationData/model_zoo',
                        help="root folder to store suspect models.")


    parser.add_argument("--root",
                        type = str,
                        default='/scr/weimin/weimin_code/src/attn_attri_sa_v4',
                        help="code file paths")


    parser.add_argument("--examples_dirpath",
                        type = str,
                        default='/scr/weimin/weimin_code/GenerationData/dev-custom-imdb',
    ...
    model_root =  args.model_root # '/scr/weimin/weimin_code/GenerationData/model_zoo'
    ...
    examples_dirpath =  args.examples_dirpath # '/scr/weimin/weimin_code/GenerationData/dev-custom-imdb'


    root = args.root # '/scr/weimin/weimin_code/src/attn_attri_sa_v4'
